...
class machine_learning:   
    ...
    def test_model(self,data, data_group, ex_data,ex_data_group,params, k_fold):
...
#Stage6A Test
_, roc_auc,spe,sen,pre,f1,accu,fpr, tpr= ML.test_model(opt_biomarker,data_group,ex_data,ex_data_group, best_param, k_fold=5)
