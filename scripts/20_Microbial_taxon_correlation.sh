...
fastspar --iterations 5 --threads $threads --otu_table $workplace$inputfile --correlation ${workplace}/median_correlation.tsv --covariance ${workplace}/median_covariance.tsv
