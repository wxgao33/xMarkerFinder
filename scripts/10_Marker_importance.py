...
#plot
plot= pd.read_table(args.Workplace+args.output+"_"+args.classifier+"_marker_importance.txt",sep = '\t',index_col = 0).T

feature_plot = plot_feature_imps(plot)
feature_plot.savefig(args.Workplace+args.output+"_"+args.classifier+'_marker_importance.pdf',bbox_inches = 'tight')
