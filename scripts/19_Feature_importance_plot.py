...
#import data
parser = argparse.ArgumentParser(description = "Feature importance plot")
...
feature_imp.savefig(args.Workplace+args.output+'_feature_importance.pdf',bbox_inches = 'tight')
